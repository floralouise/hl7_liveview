defmodule Hl7LiveviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Hl7LiveviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Hl7LiveviewWeb.Gettext, "errors", msg, opts)
    end
  end
